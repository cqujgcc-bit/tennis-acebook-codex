...
const api = {
  ...
  admin: {
    ...
    claimAdmin: (code) => mutation('admin.claimAdmin', { code }),
    ...
    // ── 平台财务管理 ──
    finance: {
      overview: () => query("admin.finance.overview"),
      settlements: (params) => query("admin.finance.settlements", params || {}),
      transactions: (params) => query("admin.finance.transactions", params || {}),
      withdraw: (amount, description) => mutation("admin.finance.withdraw", { amount: Number(amount), description }),
    },
  },
